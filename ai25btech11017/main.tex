...
\includegraphics[width=0.4\textwidth]{figs/img 2.jpeg} % Replace 'graph.jpg' with actual file name
...
\item Consider two matrices $\mathbf{P} = \begin{bmatrix} 2 & 3 \\ 1 & 4 \end{bmatrix}$ and $\mathbf{Q} = \begin{bmatrix} 5 & 4 \\ 0 & 2 \end{bmatrix}$. If $\mathbf{R} = (\mathbf{PQ})^T$ then $\det \mathbf{R}$ is \underline{\hspace{2cm}} (in integer). \hfill{\brak{\text{GATE ES 2023}}}
