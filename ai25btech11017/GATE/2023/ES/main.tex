...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/img 3.jpeg}
    \caption{}
    \label{fig:placeholder}
\end{figure}
...
\item Consider two matrices $\mathbf{P} = \myvec{ 2 & 3 \\ 1 & 4 }$ and $\mathbf{Q} = \myvec{ 5 & 4 \\ 0 & 2 }$. If $\mathbf{R} = (\mathbf{PQ})^T$ then $\det \mathbf{R}$ is \underline{\hspace{2cm}} (in integer). \hfill{\brak{\text{GATE ES 2023}}}
