...
\end{enumerate}
   ...
   \begin{enumerate}
    \begin{multicols}{2}
    \item  methionine  \item  glycine  \item  proline  \item  serine    \hfill{(GATE CY 2008)}    
    \end{multicols}
\end{enumerate}
...
\end{enumerate}
    ...
    \begin{enumerate}
    \begin{multicols}{2}
        \item  3  \item  2  \item  1  \item  4    \hfill{(GATE CY 2008)}
    \end{multicols}
\end{enumerate}
    ...
    \begin{enumerate}
\begin{multicols}{2}
        \item  20000  \item  8000  \item  5000  \item  200    \hfill{(GATE CY 2008)}
\end{multicols}
\end{enumerate}
...
\item  antibonding 
\item  ionic 
\item  nonbonding    \hfill{(GATE CY 2008)} 
\end{multicols}
\end{enumerate}
...
\item  $^3A_{2g}$ and 3 
\item  $^1T_{1g}$ and 3 
\item  $^3A_{2g}$ and 2    \hfill{(GATE CY 2008)}
\end{multicols}
\end{enumerate}
