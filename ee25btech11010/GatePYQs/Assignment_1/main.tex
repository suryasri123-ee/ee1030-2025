...
R–X, R–Y and Z, respectively, are
    ...
    \item[(D)] R–OH, R–NC, nitrene    \textbf{(GATE CY 2008)}
...
\end{center}   \textbf{(GATE CY 2008)}
 ...
 \vspace{0.5cm}
   ...
   \textbf{Q.13}  Cyanogen bromide (CNBr) specifically hydrolyses the peptide bond formed by the C-side of\\
    (A) methionine \quad (B) glycine \quad (C) proline \quad (D) serine   \textbf{(GATE CY 2008)}
...
\item[(D)] Br$_2$/FeBr$_3$   \textbf{(GATE CY 2008)}
...
\item[(B)] 50 : 50
\item[(C)] 1 : 9
\item[(D)] 99 : 1   \textbf{(GATE CY 2008)}
