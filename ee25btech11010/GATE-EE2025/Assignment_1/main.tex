...
R–X, R–Y and Z, respectively, are
    ...
    \item[(D)] R–OH, R–NC, nitrene    \textbf{(GATE-EE2025)}
...
\end{center}   \textbf{(GATE-EE2025)}
 ...
 \vspace{0.5cm}
   ...
   \textbf{Q.13}  Cyanogen bromide (CNBr) specifically hydrolyses the peptide bond formed by the C-side of\\
    (A) methionine \quad (B) glycine \quad (C) proline \quad (D) serine   \textbf{(GATE-EE2025)}
...
\item[(D)] Br$_2$/FeBr$_3$   \textbf{(GATE-EE2025)}
