...
\begin{enumerate}
\begin{multicols}{2}
\item[(A)]  $\mathbf{i}-\mathbf{j}+2\mathbf{k}$
\item[(B)]  $\mathbf{i}-2\mathbf{j}+5\mathbf{k}$
\item[(C)]  $\mathbf{i}-2\mathbf{j}-5\mathbf{k}$
\item[(D)]  $2\mathbf{i}-4\mathbf{j}$
\end{multicols}
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\begin{enumerate}
\begin{multicols}{2}
\item[(A)]  $y = \dfrac{2}{3} x^2 + 4x$
\item[(B)]  $y = \sqrt{\dfrac{2}{3} x^2 + 4x + k}$
\item[(C)]  $y = \dfrac{2}{3} x^3 - 4x + k$
\item[(D)]  $y = \dfrac{2}{3} x^3 + 4x + k$
\end{multicols}
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\begin{enumerate}
\begin{multicols}{2}
\item[(A)]  reciprocal leveling
\item[(B)]  check leveling
\item[(C)]  compound leveling
\item[(D)]  profile leveling
\end{multicols}
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\begin{enumerate}
\item[(A)]  higher than the freezing point of water
\item[(B)]  below the freezing point of water
\item[(C)]  equal to the freezing point of water
\item[(D)]  dependent upon the water content of the fruit juice 
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\begin{enumerate}
\item[(A)]  vapour pressure of water to partial pressure of water in the product
\item[(B)]  partial pressure of water in air to partial pressure of air at saturation
\item[(C)]  vapour pressure of water in equilibrium with the food to vapour pressure of pure water at the same temperature 
\item[(D)]  vapour pressure of pure water to vapour pressure of water in equilibrium with food
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\item[(A)]  0
\item[(B)]  $\omega d$
\item[(C)]  $\dfrac{2}{5} \pi \omega d$ 
\item[(D)]  $\dfrac{1}{2}\omega d$
\end{multicols}
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{Screenshot 2025-08-07 170331.png} % Replace with your file name
\end{figure}
...
\begin{multicols}{2}
\item[(A)]  $16\pi a^2$
\item[(B)]  $\dfrac{32\pi a^2}{3}$
\item[(C)]  $\dfrac{64\pi a^2}{3}$
\item[(D)]  $\dfrac{128\pi a^2}{3}$
\end{multicols}
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\begin{enumerate}
\begin{multicols}{2}
\item[(A)]  $a_1 - a_2 + a_3 - \ldots + (-1)^{n+1} a^n$
\item[(B)]  $\displaystyle \frac{1}{a_1} + \frac{1}{a_2} + \frac{1}{a_3} + \ldots + \frac{1}{a_n}$
\item[(C)]  $\displaystyle \frac{1}{a_1} - \frac{1}{a_2} + \frac{1}{a_3} - \ldots + (-1)^{n+1} \frac{1}{a_n}$
\item[(D)]  $a_1 + a_2 + a_3 + \ldots + a_n$
\end{multicols}
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\begin{enumerate}
\begin{multicols}{2}
\item[(A)] $e^x(Ce^{6x} - 6^{-1})$
\item[(B)] $e^{7x}(e^{-6x} - C)^{-1}$
\item[(C)] $e^x(Ce^{-6x} - 6^{-1})$
\item[(D)] $e^x[C e^x + (6e^x)^{-1}]$
\end{multicols}
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\begin{enumerate}
\begin{multicols}{2}
\item[(A)] $60\ \text{m}^3/\text{s}$
\item[(B)] $535\ \text{m}^3/\text{s}$
\item[(C)] $300\ \text{m}^3/\text{s}$
\item[(D)] $756\ \text{m}^3/\text{s}$
\end{multicols}
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\begin{enumerate}
\begin{multicols}{2}
\item[(A)] $100\ \text{m}^3/\text{s}$
\item[(B)] $200\ \text{m}^3/\text{s}$
\item[(C)] $800\ \text{m}^3/\text{s}$
\item[(D)] $1000\ \text{m}^3/\text{s}$
\end{multicols}
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\begin{enumerate}
\begin{multicols}{2}
\item[(A)] $D = \frac{WS}{100 - S}$
\item[(B)] $D = \frac{WS}{200 - S}$
\item[(C)] $D = \frac{2WS}{200 - S}$
\item[(D)] $D = \frac{2WS}{100 - S}$
\end{multicols}
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\begin{enumerate}
\begin{multicols}{2}
\item[(A)]  73571 and 1144 
\item[(B)]  1144 and 73571
\item[(C)]  73175 and 1144
\item[(D)]  144 and 73571
\end{multicols}
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\begin{enumerate}
\begin{multicols}{2}
\item[(A)]  cleaning, sorting, sieving and filtration
\item[(B)]  grading, weighing, sieving and filtration
\item[(C)]  sedimentation, centrifugation, filtration and sieving
\item[(D)]  sedimentation, centrifugation, cleaning and sieving
\end{multicols}
\end{enumerate}
\hfill(GATE AG 2008)\\
...
\begin{enumerate}
\begin{multicols}{2}
\item[(A)]  20 rpm, anti-clockwise
\item[(B)]  25 rpm, anti-clockwise 
\item[(C)]  180 rpm, clockwise
\item[(D)]  225 rpm, clockwise
\end{multicols}
\end{enumerate}
\hfill(GATE AG 2008)\\
