...
\begin{enumerate}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{image10.jpg}  
    \caption{}
    \label{fig:1}
    \end{figure}
...
\section*{Q. 26 to Q. 55 carry two marks each.}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{image31.jpg}  
    \caption{}
    \label{fig:2}
    \end{figure}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{image32.jpg}  
    \caption{}
    \label{fig:3}
    \end{figure}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{image33.jpg}  
    \caption{}
    \label{fig:4}
    \end{figure}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{image34.jpg}  
    \caption{}
    \label{fig:5}
    \end{figure}
    \begin{multicols}{4}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{image36.jpg}  
    \caption{}
    \label{fig:6}
    \end{figure}
    \begin{multicols}{4}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{image37.jpg}  
    \caption{}
    \label{fig:7}
    \end{figure}
    \begin{multicols}{4}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{image38.jpg}  
    \caption{}
    \label{fig:8}
    \end{figure}
    \begin{multicols}{4}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{image48.jpg}  
    \caption{}
    \label{fig:9}
    \end{figure}
...
Average elastic modulus E and Poison's ratio $\micro$ of dense sand is 60 x 10$^3$kN/m$^2$ and 0.3 respectively.
 ...
 \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{image52.jpg}  
    \caption{}
    \label{fig:10}
    \end{figure}
