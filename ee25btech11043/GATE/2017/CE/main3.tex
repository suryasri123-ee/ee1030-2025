...
\begin{enumerate}
    ...
    \item The figure shows \figref{fig} a two-hinged parabolic arch of span L subjected to a uniformly distributed load of intensity q per unit length.
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{imageq7.jpg}  
    \caption{}
    \label{fig}
    \end{figure}
...
\begin{enumerate}
    ...
    \end{figure}
        \item (B) 
         \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{image7b.jpg}  
    \caption{}
    \label{fig:2}
    \end{figure}
        \item (C) 
         \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{image7c.jpg}  
    \caption{}
    \label{fig:3}
    \end{figure}
        \item (D)  
         \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{image7d.jpg}  
    \caption{}
    \label{fig:4}
    \end{figure}
    \end{enumerate}
