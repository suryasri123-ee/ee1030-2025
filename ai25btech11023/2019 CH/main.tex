...
\end{multicols}
    ...
    \text{If heat losses are neglected, and if both the designs are feasible, which of the following statements holds true:}
...
\end{align*}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.5\linewidth]{Fig/49.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\linewidth]{Fig/53.png}
