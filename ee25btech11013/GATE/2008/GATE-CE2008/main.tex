...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{image/image6.png}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{image/image7.png}
\end{figure}
\begin{multicols}{2}
\begin{enumerate}
\item $0.255$
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{image/image5.png}
\end{figure}
