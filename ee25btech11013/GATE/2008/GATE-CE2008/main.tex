...
\item The capacities of One-way $1.5 m$ wide sidewalk persons per hour and One-way 2-lane urban road \brak{PCU \ per \  hour \ , with \  no \  frontage \  access \ , no \ standing \ vehicles \ and \ very \ little \ cross \  traffic} are respectively: \hfill \brak{GATE \ CE \ 2008}
\begin{enumerate}
\begin{multicols}{2}
\item $1.10$ and $1.06$  
\item $1.06$ and $1.02$  
...
\item Solution of \begin{align} \dfrac{dy}{dx} = \dfrac{-x}{y} \end{align}at $x = 1$ and $y = \sqrt{3}$ is: \hfill \brak{GATE \ CE \ 2008}
\begin{enumerate}
\begin{multicols}{2}
\item $x^2 - y^2 = -2$
\item $x^2 + y^2 = 4$
...
\end{cases}
\end{align}
then, the percentage probability $P\left( -\dfrac{1}{3} \leq x \leq \dfrac{1}{3} \right)$ is: \hfill \brak{GATE \ CE \ 2008}
\begin{enumerate}
\begin{multicols}{2}
\item $0.247$
\item $2.47$
...
\item A wastewater sample contains $10^{-5.6}$ mmol/l of $OH^{-}$ ions at $25$ $^\circ\text{C}$ .The $pH$ of this sample is \hfill \brak{GATE \ CE \ 2008}
...
\item \hspace{0.2cm} When the middle pontoon is removed, the deflection at H will be \hfill \brak{GATE \ CE \ 2008}
\begin{enumerate}
\item $0.2$ m
\item $0.4$ m
\item $0.6$ m
...
\item \hspace{0.2cm} When the middle pontoon is brought back to its position as shown in the figure above, the reaction at H will be \hfill \brak{GATE \ CE \ 2008}
\begin{itemize}
\item $8.6$ $kN$
\item $15.7$ $kN$
\item $19.2$ $kN$
