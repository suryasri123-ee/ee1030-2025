...
\hfill $\brak{\text{GATE GE 2025}}$
\bigskip
\item The bar chart \figref{fig:fig.1} gives the batting averages of VK and RS for $11$ calendar years from $2012$ to $2022$. Considering that $2015$ and $2019$ are world cup years, which one of the following options is true?\\
\begin{figure}[H]
    \centering
...
\hfill $\brak{\text{GATE GE 2025}}$
\bigskip
\item A planar rectangular paper has two V-shaped pieces attached as shown below in \figref{figs:fig2}.
...
\end{figure}
\textit{} 
This piece of paper is folded to make the following closed three-dimensional object as shown in \figref{figs:fig3}.
...
\hfill $\brak{\text{GATE GE 2025}}$
\bigskip
\item Identify the type of digitizing error in the following \figref{figs:fig4}.
\\
\begin{figure}[H]
    \centering
...
\hfill $\brak{\text{GATE GE 2025}}$
\bigskip
\item In the \figref{figs:fig5}, d1, d2, d3 are three independently measured distances for estimating the unknown distances $x$ and $y$.The correlation coefficient between the unknown estimates approximately equals to\\
\\
...
\hfill $\brak{\text{GATE GE 2025}}$
\bigskip
\item Independent angles AOB, BOC and AOC were observed as shown in \figref{figs:fig6}.
...
\hfill $\brak{\text{GATE GE 2025}}$
\bigskip
\item To reduce the slope distance (S) to an equivalent horizontal distance (H) as shown in the \figref{figs:fig7} given below, the following independent observations were taken.\\ 
\\ $S = 
...
\hfill $\brak{\text{GATE GE 2025}}$
\bigskip
\item Which type of contrast stretching is represented by the following \figref{figs:fig9}?\\
\begin{figure}[H]
    \centering
...
\hfill $\brak{\text{GATE GE 2025}}$
\bigskip
\item The \figref{figs:fig10} given below shows the Fourier spectrum obtained by applying filter on a remote sensing image in frequency domain.
...
\hfill $\brak{\text{GATE GE 2025}}$
\bigskip
\item Which of the following statistical classification algorithms is/are represented by the \figref{figs:fig11} given below?
\\
\begin{figure}[H]
    \centering
