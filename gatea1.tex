...
\item Let $S = \{0\} \cup \left\{ \frac{1}{4n + 7} : n = 1, 2, \ldots \right\}$. Then the number of analytic functions which vanish only on $S$ is:    \hfill{\text{GATE MA 2007}}
\begin{multicols}{4}
\begin{enumerate}
    \item infinite
    \item $0$
...
\item Let $S = \{(0,1,1), (1,0,1), (-1,2,1)\} \subseteq \mathbb{R}^3$. Suppose $\mathbb{R}^3$ is endowed with the standard inner product $\langle \cdot , \cdot \rangle$. Define $M = \{x \in \mathbb{R}^3 : \langle x, y \rangle = 0 \text{ for all } y \in S\}$. Then the dimension of $M$ equals \hfill{\text{GATE MA 2007}}
\begin{multicols}{4}
\begin{enumerate}
    \item $0$
    \item $1$
...
\item A basis of the vector space $W = \{(x,y,z,w) \in \mathbb{R}^4 : x + y + z = 0, y + z + w = 0, 2x + y - z + w = 0\}$ is  \hfill{\text{GATE MA 2007}}
\begin{enumerate}
...
\]
Then the matrix of the linear transformation $T$ with respect to the ordered basis $B = \{(0,1,0), (0,0,1), (1,0,0)\}$ of $\mathbb{R}^3$ is \hfill{\text{GATE MA 2007}}
...
\item Let $f(z) = 2^z - 2^{-z}$. Then the maximum value of $|f(z)|$ on the unit disc $D = \{ z \in \mathbb{C} : |z| \leq 1 \}$ equals      \hfill{\text{GATE MA 2007}}
\begin{multicols}{4}
\begin{enumerate}
    \item $1$
    \item $2$
