...
\begin{enumerate}[label=(\Alph*)]
\begin{multicols}{2}
\item \includegraphics[scale=0.7]{fig4.png}
\item \includegraphics[scale=0.7]{fig5.png}
\item \includegraphics[scale=0.7]{fig6.png}
\item \includegraphics[scale=0.7]{fig7.png}
\end{multicols}
\end{enumerate}
...
\hfill (GATE XL 2018)\\
\begin{enumerate}[label=(\Alph*)]
\item \includegraphics[scale=0.8]{fig9.png} \textbf{and} \ce{CH2=CH2}
\item \includegraphics[scale=0.8]{fig10.png}\textbf{and} \ce{N(CH3)2CH2CH3}
\item \includegraphics[scale=1]{fig11.png}\textbf{and} \ce{N(CH3)2CH2CH3}
\item \includegraphics[scale=0.8]{fig10.png}\textbf{and} \ce{HN(CH3)CH2CH3}
\end{enumerate}
...
\begin{enumerate}[label=(\Alph*)]
\begin{multicols}{2}
\item \includegraphics[scale=0.7]{fig12.png}\\
\item \includegraphics[scale=0.7]{fig13.png}\\
\item \includegraphics[scale=0.7]{fig14.png}\\
\item \includegraphics[scale=0.7]{fig15.png}\\
\end{multicols}
\end{enumerate}
...
\begin{enumerate}[label=(\Alph*)]
\begin{multicols}{2}
\item \includegraphics[scale=0.7]{fig17.png}
\item \includegraphics[scale=0.7]{fig18.png}
\item \includegraphics[scale=0.7]{fig19.png}
\item \includegraphics[scale=0.7]{fig20.png}
\end{multicols}
\end{enumerate}
