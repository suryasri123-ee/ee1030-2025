...
\hfill{(GATE EE 2025)}
\vspace{0cm}
\textbf{Group I} \hspace{4cm}
\textbf{Group Il}\\
P. Porphyry Cu ore \qquad \qquad \qquad \qquad 1.As\\
Q. Vein type Au ore \qquad \qquad \qquad \qquad 2.Hg\\ 
...
\end{enumerate}
\item  In electrical resistivity method, which among the following is correct with reference to Geometric Factor \brak{GF}?
\hfill{(GATE EE 2025)}
\begin{enumerate}
\begin{multicols}{2}
