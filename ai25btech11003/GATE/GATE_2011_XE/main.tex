...
\vspace{0.2cm}
\hfill\raisebox{0.5ex}{(GATE 2011 XE)} \\
(A) similar \\
(B) most \\
(C) uncommon \\
(D) available
...
\vspace{0.2cm}
\hfill\raisebox{-2.5ex}{(GATE 2011 XE)} \\
(A) 100 \\
(B) 110 \\
(C) 90 \\
(D) 95
...
\vspace{0.2cm}
\hfill\raisebox{-1.5ex}{(GATE 2011 XE)} \\
(A) 0 \\
(B) -1 \\
(C) 1 \\
(D) 2
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=.65\linewidth]{figs/B/fig1.png}
  \caption{Diagram}
  \label{B/fig1}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=.35\linewidth]{figs/B/fig2.png}
