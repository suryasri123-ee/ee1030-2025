...
# Check if the shared object file exists before attempting to load it.
if not os.path.exists(so_file_path):
    print(f"Error: Shared object file '{so_file_path}' not found.")
    print("Please make sure you have compiled the C file into a shared object.")
    exit()
...
try:
    ...
    print("Ensure the file exists and has the correct permissions.")
    exit()
