...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\columnwidth]{figs/img_7.jpg}
    \caption{Network for Q-17}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\columnwidth]{figs/img_10.jpg}
    \caption{Circuit for Q-28}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\columnwidth]{figs/img_11.jpg}
    \caption{Circuit for Q-29}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\columnwidth]{figs/img_13.jpg}
...
\item A system with transfer function $H\brak{z}$ has impulse response $h\brak{.}$ defined as $h\brak{2}=1$, h\brak{3}=-1 and h\brak{k}=0 otherwise. Consider the following statements.
\begin{align*}
...
\begin{figure}[H]
    ...
    \caption{Figure for Q-57 and Q-58}
...
\begin{figure}[H]
    ...
    \caption{Figure for Q-59 and Q-60}
