...
\noindent	
\brak{i} Some roses are red.\\
\brak{ii} All red flowers fade quickly.\\
\brak{iii} Some roses fade quickly.\\
...
\brak{I} A water aquifer is attached to this gas reservoir.\\
\brak{II} P/Z vs. Gp curve must always be a straight line for water encroachment in a gas
reservoir.\\
\brak{III} The ultimate gas recovery is diminished due to water encroachment.\\
...
\brak{I}It can be used for $CO_2$ sequestration\\
\brak{II} $CO_2$ can exist in the form of a dense fluid at reservoir conditions\\
\brak{III} $CO_2$ can convert to hydrocarbon at the reservoir temperature and pressure\\
\brak{IV} Solubility of $CO_2$ in oil is higher compared to gases like $N_2$
...
\brak{I} Reduces the oil viscosity\\
\brak{II} Increases the formation damage\\
\brak{III} Reduces the interfacial tension\\
\brak{IV} Increases the oil viscosity
...
\noindent
\brak{I} are formed under low temperature and high pressure.\\
\brak{II} can store approximately 160 m$^3$ of gas per m$^3$ of hydrate at $25{\degree}C$ and 1 atm.\\
\brak{III} formation is an endothermic process.\\
\brak{IV} are potential sources of methane.
