...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{Figs/wavr.jpeg}
\caption{}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{Figs/WAVE1.jpeg}
\caption{}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{Figs/WAVE2.jpeg}
\caption{}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{Figs/WAVE3.jpeg}
\caption{}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{Figs/WAVE4.jpeg}
\caption{}
\end{figure}
\hfill (GATE BM 2023)
...
\draw (3.5,11.5) to[short] (4,11.5);
\draw (4,11.5) to[R] (6,11.5);
\draw (6,11.5) to[short] (7.5,11.5);
\draw (6.5,11.5) to[short] (6.5,10.75);
\draw (6.5,10.75) to[R,l={ \LARGE 7K$\Omega$}] (6.5,9.5);
\draw (3.5,11.5) to[battery1,l=$10V$] (3.5,9.5);
\draw (3.5,9.5) to[short] (6.5,9.5);
\draw (6.75,11.5) to[closing switch,l={ \Large s}] (7.5,11.5);
\draw (7.5,11.5) to[R,l={ \LARGE 10k$\Omega$}] (8.75,11.5);
\draw (6.5,9.5) to[short] (8.75,9.5);
\node [font=\LARGE] at (5,12.25) {3K$\Omega$};
\draw (8.75,11.5) to[C,l={ \LARGE 10$\mu$F}] (8.75,9.5);
\end{circuitikz}
}%
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Figs/ASSIGN.jpeg}
    \caption{Caption}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Figs/wheatstone.jpeg} 
    \caption{Caption}
    \label{fig:placeholder}
\end{figure}
\hfill (GATE BM 2023)
