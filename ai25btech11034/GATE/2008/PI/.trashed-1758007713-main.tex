...
\begin{center}
\includegraphics[width=0.45\textwidth]{figures/GATE-pi-2008-55.png} % Crop later for only Q55 figure
\end{center}
...
\begin{center}
\includegraphics[width=0.45\textwidth]{figures/GATE-pi-2008-56.png} % Crop later for only Q56 figure
\end{center}
...
\begin{center}
    \includegraphics[width=0.4\textwidth]{figures/76-77-pi-2008-gate.png}
\end{center}

\noindent
\item[\textnormal{Q.76}] The rate of heat transfer (in kW) into the wall (at $x=0$) is:\hfill{(PI 2008)}
\begin{multicols}{4}
    \begin{enumerate}[label=(\Alph*)]
\item 900 
\item 450  
...
\noindent
\item[\textnormal{Q.77}] The rate of change of energy storage (in kW) in the wall is:\hfill{(PI 2008)}
\begin{multicols}{4}
    \begin{enumerate}[label=(\Alph*)]
\item  130 
\item 120 
