...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{figs/Q-6.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\linewidth]{figs/Q-28.png}
    \caption{}
    \label{}
\end{figure}
\begin{enumerate}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\linewidth]{figs/Q-32.png}
...
\item Ant species X preys upon ant species Y. A researcher has the following set of observations regarding the behaviour of species X where aggression signifies a predatory response. \input{tables/table1}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.2\linewidth]{figs/Q-35.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\linewidth]{figs/Q-36.png}
