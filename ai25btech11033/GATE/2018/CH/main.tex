...
\usepackage{amsmath} %<-- ADD THIS LINE BACK. It's essential for math commands.
\usepackage{txfonts}
\usepackage{textcomp}
\usepackage{xcolor}
...
% Misc layout packages
\usepackage{array,longtable,multirow,multicol,hhline,tabularx,float}
\usepackage{caption}
\usepackage[a4paper,margin=1in]{geometry}
\usepackage{fancyhdr}
\setlength{\headheight}{14pt} 

% Conditional package load
% \IfFileExists{gvv.sty}{\usepackage{gvv}}{\PackageWarning{main}{gvv.sty not found; continuing without it}}
