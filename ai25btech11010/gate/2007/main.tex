...
\begin{enumerate}
		\begin{multicols}{2}
    \item $-4$$\begin{vmatrix} 1 & 1 \\ 0 & 3 \end{vmatrix}$
    \item $-2$$\begin{vmatrix} -2 & 1 \\ 0 & 3 \end{vmatrix}$
    \item $\begin{vmatrix} 1 & 3 \\ 1 & 1 \end{vmatrix}$
	    \item$-\frac{1}{2}$$\begin{vmatrix} -2 & 1 \\ 0 & 3 \end{vmatrix}$
		    \end{multicols}
\end{enumerate}
