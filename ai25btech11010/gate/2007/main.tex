...
\begin{center}
    \huge{MN:MINING ENGINEERING}\\
    \large{AI25BTECH11010 - DHANUSH KUMAR A}
\end{center}
...
\begin{enumerate}
		\begin{multicols}{2}
    \item $-4$$\begin{bmatrix} 1 & 1 \\ 0 & 3 \end{bmatrix}$
    \item $-2$$\begin{bmatrix} -2 & 1 \\ 0 & 3 \end{bmatrix}$
    \item $\begin{bmatrix} 1 & 3 \\ 1 & 1 \end{bmatrix}$
	    \item$-\frac{1}{2}$$\begin{bmatrix} -2 & 1 \\ 0 & 3 \end{bmatrix}$
		    \end{multicols}
\end{enumerate}
