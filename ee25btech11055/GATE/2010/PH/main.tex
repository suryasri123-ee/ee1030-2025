...
\item Given the recurrence relation for the Legendre polynomials $$(2n+1) x P_n(x)=(n+1) P_{n+1}(x)+nP_{n-1}(x)$$, which of the following integrals has a non-zero value?\hfill\brak{\text{GATE PH 2010}}
...
\item Match the typical spectra of stable molecules with the corresponding wave-number range\hfill\brak{\text{GATE PH 2010}}
...
\item Two magnetic dipoles of magnitude m each are placed in a plane as shown. The energy of interaction is given by\hfill\brak{\text{GATE PH 2010}}
	\begin{figure}[H] \centering
		\caption*{} \label{38} \includegraphics[width=0.1\columnwidth]{figs/38.png}
	\end{figure}
...
\begin{enumerate} \begin{multicols}{4}
\begin{figure}[H]
	\item \caption*{} \label{41a} \includegraphics[width=0.51\columnwidth]{figs/41a.png}
	\item \caption*{} \label{41b} \includegraphics[width=0.51\columnwidth]{figs/41b.png}
	\item \caption*{} \label{41c} \includegraphics[width=0.51\columnwidth]{figs/41c.png}
	\item \caption*{} \label{41d} \includegraphics[width=0.51\columnwidth]{figs/41d.png}
\end{figure}
\end{multicols} \end{enumerate}
...
\item A particle of mass m is confined in an infinite potential well: $$V(x) = \begin{cases} 0 & \text{if } 0<x<L, \\ \infty & \text{otherwise} \end{cases}$$. It is subjected to a perturbing potential $V_p(x) = V_0 \sin\left(\frac{2\pi x}{L}\right)$ within the well. Let $E^{(1)}$ and $E^{(2)}$ be the corrections to the ground state energy in the first and second order in $V_0$, respectively. Which of the following are true?\hfill\brak{\text{GATE PH 2010}}
	\begin{figure}[H] \centering
		\caption*{} \label{47} \includegraphics[width=0.4\columnwidth]{figs/47.png}
	\end{figure}
...
\item The spectral line corresponding to the transition $$^2P_{3/2} \left(m_j = +\frac{1}{2}\right) \rightarrow ^2S_{1/2} \left(m_j = -\frac{1}{2}\right)$$ is observed along the direction of the applied magnetic field. The emitted electromagnetic field is:\hfill\brak{\text{GATE PH 2010}}
