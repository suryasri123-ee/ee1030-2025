...
\end{figure}
        \item  
           ...
           \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/i9.jpg}
...
\end{figure}
        \item  
          ...
          \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/i10.jpg}
...
\end{figure}
        \item 
           ...
           \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/i11.jpg}
...
\end{figure}
    ...
    \item Which one of the following equations is valid for the circuit shown below? (GATE-IN-2008 EE 2025)
       ...
       \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/i14.jpg}
    \label{fig:placeholder14}
\end{figure}
    \begin{enumerate} 
        \item $I\textsubscript{3}+ I\textsubscript{5}- I\textsubscript{6}+ I\textsubscript{7} = 0 $
        \item  $I\textsubscript{3}- I\textsubscript{5}+ I\textsubscript{6}+ I\textsubscript{7} = 0 $
        \item $I\textsubscript{3}+ I\textsubscript{5}+ I\textsubscript{6}+ I\textsubscript{7} = 0 $ 
        \item $I\textsubscript{3}+ I\textsubscript{5}+ I\textsubscript{6}- I\textsubscript{7} = 0 $
    \end{enumerate}
    
    \item  For the circuit shown below the steady-state current I is (GATE-IN-2008 EE 2025)

   \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/i15.jpg}
...
\end{figure}
    ...
    \item For the circuit shown below the voltage across the capacitor is (GATE-IN-2008 EE 2025)

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/i16.jpg}
...
\end{figure}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/i20.jpg}
...
\end{figure}
    ...
    \item  For the op-amp circuit shown below, v\textsubscript{0} is approximately equal to (GATE-IN-2008 EE 2025)
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/i21.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/i32.jpg}
...
\item The quantization error of the ADC is (GATE-IN-2008 EE 2025)
           \begin{enumerate} 
              \item 0           
              \item $\underset{-}{+}$ 0.012 \%
              \item $\underset{-}{+}$ 0.024 \%
...
filter in channel 1 should be (GATE-IN-2008 EE 2025)
           \begin{enumerate} 
              \item f\textsubscript{c} $<$ 100 kHz         
              \item f\textsubscript{c} = 100kHz
              \item 100kHz $<$ f\textsubscript{c} $<$ 200kHz
...
2, 1, 3, 1, 4, 1, ....., the input connected to channel 1 will be sampled at the rate of (GATE-IN-2008 EE 2025) (GATE-IN-2008 EE 2025)
           \begin{enumerate} 
              \item 25k samples/s           
              \item 50k samples/s
              \item 100k samples/s
