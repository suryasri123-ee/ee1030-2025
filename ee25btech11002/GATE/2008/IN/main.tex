...
\begin{multicols}{4}
    ...
    \item A linear variable differential transformer (LVDT) is \hfill (GATE-IN 2008)
    \begin{multicols}{2}
    \begin{enumerate} 
    ...
    \item The temperature being sensed by a negative temperature coefficient (NTC) type thermistor is linearly increasing. Its resistance will \hfill (GATE-IN 2008)
    \begin{multicols}{2}
    \begin{enumerate} 
...
\section*{Questions 21-75 (2 marks each)}
    \item The expression e\textsuperscript{-lnx} for $x > 0$ is equal to \hfill (GATE-IN 2008)
    \begin{multicols}{4}
    \begin{enumerate} 
        \item $-x$ 
        \item $x$
...
\begin{multicols}{4}
    ...
    \item The Fourier transform of $x(t)=e\textsuperscript{-at}u(-t)$, where $u(t)$is the unit step function,\hfill (GATE-IN 2008)
    \begin{multicols}{2}
    \begin{enumerate} 
    ...
    \item In the circuit shown below the maximum power that can be transferred to the load Z\textsubscript{L} is \hfill (GATE-IN 2008)
...
\end{figure}
    ...
    \item For the circuit shown below the input resistance $R_{11} = \frac{V_{1}}{I_{1}}\Big|_{I_{2}=0}$is \hfill (GATE-IN 2008)
  \begin{figure}[H]
    \centering
...
\begin{multicols}{4}
    ...
    \item In the circuit shown below the average power consumed by the 1$\Omega$ resistor is \hfill (GATE-IN 2008)
...
\begin{multicols}{2}
    ...
    \item  For the op-amp circuit shown below, v\textsubscript{0} is approximately equal to \hfill (GATE-IN 2008)
    \begin{figure}[H]
    \centering
...
\item  Consider a discrete-time LTI system with input $x[n] = \delta[n] +\delta[n-1] $ and impulse response $h[n] =\delta[n]-\delta[n-1]$. The output of the system will be given by \hfill (GATE-IN 2008)
\begin{multicols}{2}
  \begin{enumerate} 
  ...
  \end{multicols}
    ...
    \item Consider a discrete-time system for which the input $x[n]$ and the output $y[n]$ are related as $y[n]$ = $x[n]$-\(\frac{1}{3}\)$y[n-1]$. If $y[n] = 0$ for $n < 0$ and $x[n] = \delta[n]$, then $y[n]$ can be expressed in terms of the unit step $u[n]$ \hfill (GATE-IN 2008)
    \begin{multicols}{4}
    \begin{enumerate} 
    ...
    \item  If the bandwidth of a low-pass signal g(t) is 3 kHz, the bandwidth of g\textsuperscript{2}(t) will be    \hfill (GATE-IN 2008)
    \begin{multicols}{4}
    \begin{enumerate} 
            \item \(\frac{3}{2}\) MHz 
            \item 3 MHz
   ...
   \item Consider the AM signal $s(t) = [1+ m(t)]\cos{2{\pi}ft}$ . It is given that the bandwidth of the real, low-pass message signal $m(t)$ is 2 kHz. If f\textsubscript{c} = 2 MHz, the bandwidth of the band-pass signal $s(t)$ will be \hfill (GATE-IN 2008)
\begin{multicols}{4}
    \begin{enumerate} 
            \item  2.004 Hz
            \item  2 kHz
...
\item The region of convergence of the z-transform of the discrete-time signal $x[n]$ = 2\textsuperscript{n} $u[n]$ will be  \hfill (GATE-IN 2008)
\begin{multicols}{4}
          \begin{enumerate} 
              \item  \( |z| \) $>$ 2
              \item  \( |z| \) $<$ 2
...
function. If the output of the system corresponding to an impulse input $\delta(t)$ is $h(t)$, then $h(t)$ is \hfill (GATE-IN 2008)
\begin{multicols}{2}
          \begin{enumerate} 
...
of R that gives FSD for a sinusoidal input voltage of 100 mV (RMS) is \hfill (GATE-IN 2008)
\begin{figure}[H]
    \centering
...
\item The open loop transfer function of a unity feedback system is $G(s)$ =$\frac{K(s+2)}{(s+1+j1)(s+1-j1)}$ The root locus plot of the system has \hfill (GATE-IN 2008)
           \begin{enumerate} 
...
\item If a first order system and its time response to a unit step input are as shown below, the gain K is \hfill (GATE-IN 2008)
\begin{figure}[H]
    \centering
...
The transfer function$\frac{Y(s)}{U(s)}$ of the system will be \hfill (GATE-IN 2008)
\begin{multicols}{4}
           \begin{enumerate} 
              \item $\frac{1}{s}$           
              \item $\frac{1}{s(s+3)}$
...
\item When R is 2k$\Omega$ + $\Delta$$R$ , V\textsubscript{AN} is \hfill (GATE-IN 2008)
\begin{multicols}{4}
           \begin{enumerate} 
              \item 6 V
              \item 6.0024 V
...
\item  At time t = 0\textsuperscript{+}, current I is \hfill (GATE-IN 2008)
\begin{multicols}{4}
           \begin{enumerate} 
              \item  -$\frac{5}{3}$ A    
              \item  0 A
...
\item At time t = 0\textsuperscript{+}, $\frac{dI\textsubscript{2}}{dt}$ \hfill (GATE-IN 2008)
\begin{multicols}{4}
           \begin{enumerate} 
              \item  -5 A/s       
              \item  -$\frac{10}{3}$ A/s 
