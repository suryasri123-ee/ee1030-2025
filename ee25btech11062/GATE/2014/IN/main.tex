...
\setcounter{enumi}{25}
    ...
    \item The loop transfer function of a feedback control system is given by $$G\brak{s}H\brak{s} = \frac{1}{s\brak{s+1}\brak{9s+1}}$$ Its phase crossover frequency \brak{\text{in rad/s}}, approximated to two decimal places, is \underline{\hspace{2cm}}.
