...
\begin{figure}[H]
\begin{enumerate}
\item \includegraphics[width = 0.4\columnwidth]{q10a} \caption*{} \label{q10a}
\item \includegraphics[width = 0.4\columnwidth]{q10b} \caption*{} \label{q10b}
\item \includegraphics[width = 0.4\columnwidth]{q10c} \caption*{} \label{q10c}
\item \includegraphics[width = 0.4\columnwidth]{q10d} \caption*{} \label{q10d}
\end{enumerate}
\end{figure}
...
\item $$\frac{e^{-3s}}{s+3}$$
\item $$\frac{3e^{-3s}}{s+1}$$
\item $$\frac{3e^{-\brak{s/3}}}{s+1}$$
\item $$\frac{e^{-\brak{s/3}}}{s+3}$$
\end{enumerate}
...
\end{figure}
\begin{enumerate}
\item $$\frac{2G_1\brak{s}G_2\brak{s} + 2G_1\brak{s}G_3\brak{s}}{1+G_2\brak{s}+G_3\brak{s}}$$
\item $$\frac{2 + G_1\brak{s} + G_3\brak{s} + G_2\brak{s}}{1+G_2\brak{s}}$$
\item $$\frac{G_1\brak{s} + G_3\brak{s} - G_2\brak{s}}{2 + G_2\brak{s}}$$
\item $$\frac{2G_1\brak{s}G_2\brak{s} + 2G_1\brak{s}G_3\brak{s} - G_1\brak{s}}{1+G_2\brak{s}+G_3\brak{s}}$$
\end{enumerate}
...
\item $$R_S||R_L|| g_m^{-1}$$
\item $$R_S||g_m^{-1}$$
\item $$\brak{R_S + R_L}||g_m^{-1}$$
\item $$\frac{R_L g_m}{1 + R_S g_m\brak{R_L||g_m^{-1}}}$$
\end{enumerate}
