...
\begin{document}
	...
	\begin{enumerate}
		...
		\item The system of linear equations \textbf{Ax = 0}, where textbf{A} is an nxn matrix, has a non-trivial solution ONLY if-
		
		\begin{enumerate}
			\begin{multicols}{2}
				\item rank of \textbf{A}$>$n
				\item rank of \textbf{A}$=$n
				\item rank of \textbf{A}$<$n
				\item \textbf{A} is an identity matrix
			\end{multicols}
		\end{enumerate}
		...
		\begin{enumerate}
			\begin{multicols}{2}
				\item $\sqrt{\frac{intrinsic: reaction rate}{diffusion: rate}}$
				\item $\sqrt{\frac{diffusion: rate}{intrinsic: reaction rate}}$
				\item ${\frac{intrinsic: reaction rate}{diffusion: rate}}$
				\item ${\frac{diffusion: rate}{intrinsic: reaction rate}}$
			\end{multicols}
		\end{enumerate} 
		...
		$\begin{bmatrix}
			...
			4 & 3
		\end{bmatrix}$
		are 5 and -1. Then the eigenvalues of -2\textbf{A}+3\textbf{I}\brak{I is 2x2 identity matrix} are 
		\begin{enumerate}
			\begin{multicols}{4}
				\item  -7 and 5
				\item  7 and -5
		...
		If the overall recovery of pure water \brak{through stream W} is 0.75 kg/kg feed, then the recycle ratio \brak{R/F} is 
		\begin{enumerate}
			\begin{multicols}{4}
				\item 0.25
				\item 0.5
		...
		Assuming the flow to be steady and laminar in both drain pipes, if the volumetric flow rate in the larger pipe is 16 times of that in the smaller pipe, the ratio $D_1/ D_1$ is 
		\begin{enumerate}
			\begin{multicols}{4}
				\item 2
				\item 4
		...
		\item The terminal settling velocity mm diameter glass sphere \brak{\text{density: $2500$kg / }m^3} in a viscous Newtonian liquid \brak{\text{density: $1500$kg / }m^3 } is 100 s /mu m/s .If the particle Reynolds small and the value of acceleration due to gravity is 9.81m /$s^2$ the viscosity of the liquid \brak{in Pa.s} is 
		\begin{enumerate}
			\begin{multicols}{4}
				\item 100
				\item 196.2
		...
		\item For the composite wall shown below \brak{Case 1}, the steady state interface temperature is $180\degree C$ If the thickness of layer P is doubled \brak{Case 2}, then the rate of heat transfer \brak{assuming 1-D conduction} is reduced by \\
		...
		\begin{enumerate}
			...
			\item Density of reaction mixture \brak{independent of temperature} = $1200 kg/m$ Average heat capacity of feed stream \brak{independent of temperature} = 2000 J/kg.K
			\item Heat of reaction \brak{independent of temperature}120 kJ/mol of A reacting
			\item If the maximum allowable temperature in the reactor is 800 K, then the feed temperature \brak{in K} should not exceed
		\end{enumerate} 
		\begin{enumerate}
			\begin{multicols}{2}
				\item 400
		...
		\\ \includegraphics[width=0.5\textwidth]{q40.png}
		
		
		
		The mean residence time of the fluid in the reactor \brak{in minutes} is 
		\begin{enumerate}
			\begin{multicols}{2}
				\item 5.0
				\item 7.5
		...
		\\ \includegraphics[width=0.5\textwidth]{q43.png}
		...
		\includegraphics[width=0.5\textwidth]{q44.png}
		...
		\item A column costs Rs. 5.0 lakhs and has a useful life of 10 years. Using the double declining balance depreciation method, the book value of the unit at the end of five years \brak{in lakhs of Rs.} is 
		\begin{enumerate}
			\begin{multicols}{2}
				\item 1.21
				\item 1.31
		...
		\item An equi-molar mixture of four hydrocarbons \brak{1, 2, 3, 4} is to be separated into high purity individual components using a sequence of simple distillation columns \brak{one overhead and one bottom stream}. Four possible schemes are shown below.
		...
		\item The work required for compression \brak{in kJ / mol } is 
		\begin{enumerate}
			\begin{multicols}{4}
				\item 3.74
				\item 6.24
		...
		\item The final pressure $P_{2}$ \brak{in bar} is 
		\begin{enumerate}
			\begin{multicols}{4}
				\item $2^\frac{3}{4}$
				\item $2^\frac{5}{4}$
		...
		\includegraphics[width=0.5\textwidth]{q53.png}
		...
		\item If the enthalpy of the distillate with reference to the feed is 3000 kJ/kmol, and the enthalpy of the bottoms with reference to the feed is -1000 kJ/kmol, the heat duty of the preheater \brak{Q in kJ / hr } is 
		\begin{enumerate}
			\begin{multicols}{4}
				\item $-2\times10^6$
				\item $-1\times10^6$
		...
		A free jet of water is emerging from a nozzle \brak{diameter 75 mm} attached to a pipe \brak{diameter 225 mm} as shown below.
		...
		\item The gauge pressure \brak{in kPa} at point B is  
		\begin{enumerate}
			\begin{multicols}{4}
				\item 80.0
				\item 100.0
		...
		\textbf{Statement for Linked Answer Questions 57 and 58}
		\\ The liquid-phase reaction A $--> $B + C is conducted isothermally at $50\degree C$ in a continuous stirred tank reactor \brak{CSTR}. The inlet concentration of A is 8.0 gmol/liter. At a space time of 5 minutes, the concentration of A at the exit of CSTR is 4.0 gmol/liter. The kinetics of the reaction is
