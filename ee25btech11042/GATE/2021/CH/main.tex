...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{enumerate} 
		\begin{figure}[h!] 
		\item 	\includegraphics[width = 0.4\columnwidth]{q2a}
		\item 	\includegraphics[width = 0.4\columnwidth]{q2b}
		\item	\includegraphics[width = 0.4\columnwidth]{q2c}
		\item 	\includegraphics[width = 0.4\columnwidth]{q2d}
			\caption*{}
			\label{fig:q2options}
		\end{figure}
	    \end{enumerate}
		...
		\begin{enumerate}
			\begin{multicols}{2}
				\item \includegraphics[width = 0.4\columnwidth]{q4a}
				\item \includegraphics[width = 0.4\columnwidth]{q4b}
				\item \includegraphics[width = 0.4\columnwidth]{q4c}
				\item \includegraphics[width = 0.4\columnwidth]{q4d}
			\end{multicols}
		\end{enumerate}
		...
		\item Details of prices of two items P and Q are presented in the above table. The ratio of cost of item P to cost of item Q is $3:4$. Discount is calculated as the difference between the marked price and the selling price. The profit percentage is calculated as the ratio of the difference between selling price and cost, to the cost %$\brak{\text{Profit} \% = \frac{\text{selling price}-\text{cost}}{\text{cost}}\times100}$. 
...
Nipun Dasari <nipun.dasari14@gmail.com>
