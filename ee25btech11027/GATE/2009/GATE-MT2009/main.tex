...
\item  In an ideal HCP packing , the c/a ratio is:\hfill\brak{GATE-MT2009}
...
\end{enumerate}
\end{multicols}
\item Match the following conditions in group 1 with the characteristics in group 2.\hfill\brak{GATE-MT2009}
\begin{center}
\begin{tabular}{c c}
Group 1     &Group2  \\
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{IMAGES/Q.53.png}
    \label{fig:placeholder}
\end{figure}
