...
\begin{enumerate}[label=Q.\arabic*]
    ...
    \item The number that least fits this set: $(324, 441, 97, 64)$ is \_\_\_\_\_.
    ...
    \item It takes 10 s and 15 s, respectively, for two trains travelling at different constant speeds to completely pass a telegraph post. The length of the first train is 120 m and that of the second train is 150 m. The magnitude of the difference in the speeds of the two trains (in m/s) is \_\_\_\_\_.
...
\begin{enumerate}[label=Q.\arabic*,start=6]
    \item The velocity V of a vehicle along a straight line is measured in m/s and plotted as shown with respect to time in seconds. At the end of the 7 seconds, how much will the odometer reading increase by (in m)?
   
    
    % \begin{center}
    %     \includegraphics[width=0.5\textwidth]{velocity_graph.png}
    % \end{center}
    
    \begin{enumerate}[label=(\Alph*)]
     \includegraphics[width=0.6\linewidth]{6_1.png}
        \item 0    
        \item 3    
        \item 4    
        \item 5
...
\begin{enumerate}[label=Q.\arabic*]
    \item The value of \[ \lim_{x \to 0} \left( \frac{e^x - 1}{\sin x} \right) \] is equal to \_\_\_\_\_.
    
    \textbf{GATE EE 2025}
    
    \item The function \[ f(x) = \frac{1}{1 + |x|} \] is
    ...
    \item The value of the definite integral \[ \int_1^e (\ln x) \, dx \] is equal to \_\_\_\_\_.
    
    \textbf{GATE EE 2025}
    
    \item For a complex number \[ Z = \left( \frac{1}{2} + \frac{\sqrt{3}}{2} i \right) \], the value of \[ Z^e \] is
    ...
    \item Using the gamma ray log given in the figure, the shaliness index for point S is \_\_\_\_\_\%.
   ...
   \includegraphics[width=0.6\linewidth]{7_1.png}
    ...
    \item The three main stages of evolution of organic matter in sediments are Catagenesis (C), Diagenesis (D) and Metagenesis (M). Their chronological order is  
    ...
    The radius of curvature will be \_\_\_\_\_ ft.
    ...
    \item The figure shows the producing gas oil ratio (GOR) behaviour with time for an oil reservoir under primary production. At initial reservoir condition, $P_b$ is the bubble point pressure of the crude oil. $P_R(t)$ represents the reservoir pressure at time 't'. Which of the following statements is TRUE?
    \includegraphics[width=0.9\linewidth]{12_1.png}
    ...
    \item Production of coal bed methane (CBM) is based on
...
\begin{enumerate}[label=Q.\arabic*,start=26]
    \item The divergence of the velocity field $\vec{V} = (x^2 + y)\hat{i} + (z - 2xy)\hat{j} + (xy)\hat{k}$ at (1, 1, 1) is \_\_\_\_\_.
    ...
    \item Consider the matrix, $M = \begin{bmatrix} 5 & 3 \\ 3 & 5 \end{bmatrix}$. The normalized eigen-vector corresponding to the smallest eigen-value of the matrix $M$ is  
    ...
    \item A section of a clean sandstone reservoir was logged and found to have a porosity of 10\%. The cementation (m) and saturation (n) exponents are equal to 2. The constant 'a' in Archie's saturation equation is 1. The formation water resistivity is 0.036 ohm-meter and the formation resistivity is 10 ohm-meter.  
    ...
    \item One thousand sacks of cement are required for cementing a protection casing of setting depth of 12,000 ft (top float collar) and annular capacity of 0.40 ft$^3$ per linear ft. The cementing truck has a mixing capacity of 20 sacks per min. A 1.15 ft$^3$/cycle capacity rig mud pump having an 18 inch stroke and a $\frac{1}{2}$ inch liner operating at 60 rpm with 90\% efficiency is used for the cementing job. The total cementing time is \_\_\_\_\_ min.
    ...
    \item Using the High Pressure High Temperature (HPHT) filter press data given below, the estimated API filtration loss is \_\_\_\_\_ cm$^3$.
    
    \begin{center}
    \begin{tabular}{|c|c|}
    \hline
    Time (min) & Filtrate volume (cm$^3$) \\
    \hline
    1.0 & 6.5 \\
    7.5 & 14.0 \\
    \hline
    ...
    \item An Electric Submersible Pump (ESP) is installed at a depth of 1000 ft from the surface. The ESP gives 20 ft water head per stage. The wellhead requires 100 psi pressure.
  ...
  \includegraphics[width=0.9\linewidth]{44_1.png}
    ...
    \item The vertical lift performance (VLP) and the inflow performance relationship (IPR) curves are used to find the production operating conditions. If $P_{wf}$ is the flowing bottom-hole pressure and Q is the oil flow rate, select the CORRECT statement.
    
    \includegraphics[width=0.9\linewidth]{45_1.png}
    ...
    \item For a floating vessel, match the CORRECT pairs from Group 1 and Group 2 among the options given below. (B = Centre of buoyancy; G = Centre of gravity and M = Metacentre)
    ...
    \includegraphics[width=0.9\linewidth]{47_1.png}
    
    \textbf{GATE EE 2025}
    
    \item During a production test in an oil reservoir, the oil production rate is 200 STB/day. The producing gas oil ratio (GOR) is 800 SCF/STB and dissolved GOR is 200 SCF/STB. The formation volume factor of gas is 0.01 ft$^3$/SCF and the formation volume factor of oil is 1.2 reservoir-bbl/STB.
