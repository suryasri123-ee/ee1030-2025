...
% Q12
\item A simple quick return mechanism is shown. If the forward to return ratio is 2:1, and radius of the crank $O\_1P$ is 125 mm, the distance $d$ \brak{\text{in} mm} between crank center to lever pivot center point should be
    \begin{figure}[h]
      \centering
